<?php
    ...
    class Tourney {
        ...
        function __construct($hostName1, $location1, $date1, $time1)
        {
    ...
    class Player {
        ...
        function __construct($playerId1, $firstName1, $lastName1)
        {
    ...
    class Game {
        ...
        function __construct($player11, $player12, $player21, $player22, $tourneyId1, $gameNumber1)
        {
    ...
    class SubGame {
        ...
        function __construct($subGameNumber1, $gameId1)
        {
